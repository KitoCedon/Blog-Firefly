...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		// desktop: [
		// 	"assets/images/desktop-bg-png",
		// ],
		// 移动背景图片（支持单张或多张随机）
		mobile: "assets/images/mobile-bg.png",
		// mobile: [
	...
	banner: {
		...
		homeText: {
			...
			switchable: true,
			// 主页横幅主标题
			title: "Raining Homeland",
			// 主页横幅主标题字体大小
			titleSize: "3.8rem",
			// 主页横幅副标题
			subtitle: [
				"Endless rain, which is My harbor",
			        "Today, how do you feel",
			        "Do not fall into the black hole",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
		...
		credit: {
			...
			url: {
				...
				desktop: "https://www.pixiv.net/artworks/131098525",
				// 移动端原始艺术品或艺术家页面的 URL 链接
				mobile: "https://www.pixiv.net/artworks/124719914",
			},
		},
		// 横幅导航栏配置
		navbar: {
